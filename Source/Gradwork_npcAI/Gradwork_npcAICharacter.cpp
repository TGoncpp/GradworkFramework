...
AGradwork_npcAICharacter::AGradwork_npcAICharacter()
{
...
void AGradwork_npcAICharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AGradwork_npcAICharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
